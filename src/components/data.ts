...
let edges: Edges = {
  ...
  edge3: { source: "A", target: "D", label: "17", dashed: false },
  edge4: { source: "D", target: "E", label: "2", dashed: false },
  edge5: { source: "E", target: "F", label: "1", dashed: true },
  edge6: { source: "E", target: "G", label: "57", dashed: false },
  edge7: { source: "G", target: "H", label: "1", dashed: false },
